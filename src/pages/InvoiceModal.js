                    ...
                    <td style={{ border: '1px solid #555', verticalAlign: 'top', padding: 6, width: '58%' }}>
                      ...
                      >
                        ...
                        <div style={{ marginBottom: 4 }}>
                          Certified that the particulars given above and the amount indicated are
                          true and correct.
                        </div>

                        <div style={{ marginBottom: 6 }}>
                          <div>
                            a) Represent the price actually charged and that there is no additional
                            flow of consideration directly or indirectly from the buyer, <b>OR</b>
                          </div>

                          <div style={{ marginTop: 2 }}>
                            b) Is provisional as additional consideration will be received from the
                            buyer on account of terms and conditions of sale.
                          </div>
                        </div>
                        ...
                        <div>
                          {[
                            ...
                            'Insurance of the above goods shall be borne by the buyer. Seller shall not be liable.',
                            'Buyer undertakes to submit prescribed ST declaration to seller on demand.',
                            'Disputes, if any, shall be subject to seller\'s court jurisdiction (Palghar Jurisdiction).',
                          ].map((text, index) => (
                            <div
                              key={index}
                              style={{
                      ...
                      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <tbody>
                          <tr>
                            ...
                            <td style={{ border: '1px solid #ccc', padding: '3px 6px', fontSize: 8.5, textAlign: 'right', fontWeight: 'bold' }}>{n2((Number(invoice.subtotal||0) + Number(invoice.totalGst||0)))}</td>
                          </tr>
                          {[
